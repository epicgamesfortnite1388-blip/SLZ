...
---
Answer to question 1. : **Serialize rolls** is required because QC inspection should occure for each produced reel and also for tracking ability.
---
...
---
Answer for question 2. : Mixed. Actually for film production process, backflash is fine but for printing, lamination, slitting and sealing processes, explicit issue is required.
---
...
traceability depends on the material category. For film materials (including purchasing films and produced films), roll / pallet tracking and labeling is required. 
For cartonized products like bags and pouches, carton level tracking and labeling is required. For purchasing raw materials like PE geranuls, batch tracking is required.
---
...
Stocked intermediates is required. In each production step, WIP stocked in WIP warehouse for later conversion.
---
...
1. One user can belong (access) to multiple companies.
2. Each company has one site, so visibility is company-granular only for now.
3. IT administers memberships.
---
...
Material valuation method is WA Dated (not simple WA). 
---
